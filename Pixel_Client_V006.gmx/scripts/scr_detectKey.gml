if (!global.typing)  //hopefully the player is never typing when the player is spawned
{
    ...
    itemKey   = keyboard_check(ord("R")) || gamepad_button_check(0, gp_face4);
    //itemPickupKey = keyboard_check(ord("Q")) || gamepad_button_check(0, gp_face2); //the B button
}
